...
from CRLS_APCSP_autograder.app.scratch_33_34_alternate import scratch_feedback_33_34_alternate
import sys
...
if not person:
    master_grader(fulltext_search, doc_name_to_rubric_name, value_cells, sheet_name=rubric_sheet_name,
                  ...
                  scratch_rubric_suffix=' - Lab 3.3 / 3.4 alternate - rubric')
else:
    master_grader(fulltext_search, doc_name_to_rubric_name, value_cells, sheet_name=rubric_sheet_name,\
                  scorer=scratch_feedback_32_alternate, scratch_file=True, scratch_lab_num='3.2_alternate',
                  scratch_rubric_suffix=' Lab 3.3 / 3.4 alternate - rubric', person=person)
