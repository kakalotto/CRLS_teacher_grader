    ...
    runs = {'23a_name_reply': [
        ...
        '44_1': [
            [brickLayer(0, 0, 0, variables={"numbers": [5, 2, -4, 0, ]}),
             [[1, '3',
               "Pressed '1'.  Numbers list is [5, 2, -4, 0].  Sum should be 3"],
              [2, '5',
               "Pressed '1'.  Numbers list is [5, 2, -4, 0].  Sum should be 3, not 555.<br>",
               ],
              [2, '9',
               "Pressed '1'.  Numbers list is [5, 2, -4, 0].  Sum should be 3, not 999.<br>",
               ],
              ],
             ],
