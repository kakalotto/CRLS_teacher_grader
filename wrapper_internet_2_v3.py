...
from CRLS_APCSP_autograder.app.internet_2_v3 import route_docs_internet_2_v3 as power
...
fulltext_search = 'Explain how fault-tolerant'
person = ''
people = []
print(sys.argv)
if len(sys.argv) == 2:
...
match_cells = ['D3', 'D4', 'D6', 'D7', 'D9', 'D11', 'D13',  'D15', 'D17', 'H4', 'H5',
               'H6', 'H7', 'H8', 'H9', 'H10']
