...
declare -a DocsArray=("binary_practice_v5" "cybersecurity" "encoding_black_and_white_v3" "encoding_color" "encoding_text_v1" "encryption_1a"  \
                   ...
                   "level1_internet2" "lossless_compression_v2" "lossy_compression_v2" "mobile" "physical_security" \
                   "privacy_policies" "programming_errors" "python_1020" "python_1030"\
...
declare -a DocsArray=("anonymity_and_privacy" "multimedia" "network_protocols_revisited" "nmap_1" "nmap_2" "nmap_3_vs_firewall"\
                      "passive_recon" "passwords_revisited" "proxies" "stealing_password_from_unsecured_system" "tor_1" "vpn_1")
for val in ${DocsArray[@]}; do
   sed -i  's/from app.docs_labs.docs /from CRLS_APCSP_autograder.app.docs_labs.docs /' CRLS_APCSP_autograder/app/$val.py
   sed -i  's/from app.routes /from CRLS_APCSP_autograder.app.routes /' CRLS_APCSP_autograder/app/$val.py
done
...
declare -a PythonArray=("python_1040" "python_1060" "python_2021" "python_2032a" "python_2032b" "python_2040" \
                        ...
                        "python_4021" "python_4028" "python_4031" "python_6022" "python_6032" "python_6042" "python_6050")
...
declare -a PythonArray=("python_1040" "python_1060" "python_2021" "python_2032a" "python_2032b" "python_2040" \
                        ...
                        "python_4028" "python_6022" "python_6032" "python_6042" "python_6050")
for val in ${PythonArray[@]}; do
...
declare -a PythonArray=("python_1040" "python_1060" "python_2021" "python_2032a" "python_2032b"  "python_2051b" \
                        ...
                        "python_labs/python_3_020" "python_labs/python_4_028" "python_6050")
for val in ${PythonArray[@]}; do
...
declare -a PythonArray=("python_3020" "python_3027" "python_4013" "python_4021" "python_4028" \
                        "python_4031" "python_labs/python_4_03x" "python_6022" "python_6032" "python_6042" "python_6050")
for val in ${PythonArray[@]}; do
...
cp ../CRLS_APCSP_autograder/app/scratch_labs/scratch_4_4.py CRLS_APCSP_autograder/app/scratch_labs
...
sed -i  's/from app.scratch_labs.scratch /from CRLS_APCSP_autograder.app.scratch_labs.scratch /' CRLS_APCSP_autograder/app/scratch_labs/scratch_4_4.py
...
declare -a StringArray=("scratch_13" "scratch_15" "scratch_1x" "scratch_22" "scratch_23a" "scratch_23b" "scratch_24"\
                        ...
                        "scratch_43a" "scratch_labs/scratch_4_3" "scratch_43b"   "scratch_44" )
...
sed -i  's/from app.scratch_labs.scratch_4_4 /from CRLS_APCSP_autograder.app.scratch_labs.scratch_4_4  /' CRLS_APCSP_autograder/app/scratch_44.py
