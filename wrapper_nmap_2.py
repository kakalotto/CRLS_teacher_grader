...
from CRLS_APCSP_autograder.app.nmap_2 import route_docs_nmap_2 as power
...
fulltext_search = 'The default scan checks just ping, port 445, and port 80, and only scans the top ' \
...
value_cells = ['B3', 'B5', 'B7', 'B8', 'B9', 'B10',
               'B11', 'B12', 'B13', 'B16', 'B17', 'B18',
               'B19', 'B20', 'B21', 'B22', 'B23' ,'B31',]
rubric_sheet_name = 'Sheet1'

match_cells = ['D4', 'D6', 'D7', 'D8', 'D9', 'D10', 'D11',  'D12', 'D13', 'D16', 'D17',
